...
class TestSmokeTest():
  ...
  def test_nameandLogoTest(self):
    ...
    self.driver.set_window_size(1290, 859)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("SpongeBob")
    self.driver.find_element(By.NAME, "lname").send_keys("SquarePants")
    self.driver.find_element(By.NAME, "bizname").send_keys("Krusty Krab")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Head Chef")
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("username")
